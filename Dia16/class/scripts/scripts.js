document.addEventListener('DOMContentLoaded', () => {
        ...
        capsula.forEach(cap => {
            ...
            <div class="botones">
                <div class="terminadoNegativo">
                    <img src="./storage/img/checkIcon.png" status="${cap["status"]}" data-id="${cap["id"]}" alt="" class='completado'>
                </div>
                <div class="eliminadoNegativo">
                    <img src="./storage/img/garbageIcon2.png" status="${cap["status"]}" data-id="${cap["id"]}" alt="" class='eliminado'>
                </div>
            </div>
                `
    ...
    async function botonCompletado() {
        ...
        if (status == "On hold") {
            await fetch(`https://689a1690fed141b96ba1d16c.mockapi.io/data/tasks/${id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
